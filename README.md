...
- Commit 2 nemění schema, parser, scanner persistence, Media Check ani subtitle model. Veřejné vytvoření/přiřazení variant groups a bezpečnost jejich interakce s duplicate workflow jsou plánovaný samostatný **Commit 3 – Manual Video Variant authority UI**.
