...
- První schema krok Video Variant záměrně nemění canonical numbering, unresolved/confirmed duplicate workflow, Media Check ani subtitle linking. Variant-aware logické počty a duplicate grouping jsou následující samostatný krok; do té doby all-`NULL` data používají přesně dosavadní semantiku.
